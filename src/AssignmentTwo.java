public class AssignmentTwo {
    ...
    public void partSeven() {
        System.out.println("\n=== Part 7: Demonstration of Importing Cycling History from Files ===");
        // 1. Create a new Ride object
        Ride importRide = new Ride("Import testing ride", "Test Ride", null, 5);
        // 2. Import CSV file generated by Part 6
        String filePath = "rideHistory.csv";
        importRide.importRideHistory(filePath);
        // 3. Verify import results: number of people and details printed
        System.out.println("\nNumber of historical riders imported：");
        importRide.numberOfVisitors();
        System.out.println("\nImported cycling history details：");
